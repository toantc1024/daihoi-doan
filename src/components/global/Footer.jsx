    ...
    <footer className="footer p-10 bg-base-200 text-base-content">
      <div className="footer-content flex flex-col items-center justity-center">
        <div className="flex items-center">
          <img src={logo} alt="FIT Logo" className="w-40 h-auto mb-4" /> {/* Adjust logo size and margin */}
          <div className="ml-4 mb-14"> {/* Add some space to the left */}
            <hr className="my-4 w-1 border-gray-400"  orientation="vertical" /> {/* Add a vertical rule */}
            <div className="flex flex-col mt-4"> {/* Move address up a bit */}
              <p className="text-center">
                ĐOÀN TNCS HỒ CHÍ MINH
                <br />
                TRƯỜNG ĐẠI HỌC SƯ PHẠM KỸ THUẬT TP. HCM
              </p>
              <p className="text-center">Số 1 Võ Văn Ngân, Linh Chiểu, Tp.Thủ Đức</p>
            </div>
          </div>
        </div>
        <p className="text-center">
